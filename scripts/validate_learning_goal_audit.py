...
REQUIRED_SNIPPETS = {
    "docs/17-learning-goal-audit.md": [
        ...
        "Reuse learned dictionary entries before and after ASR.",
        "SpeechRecognitionHintsUseCase",
        "contextualStrings",
        "recognitionHints",
        "legacy dictionary decoding",
        "Learn environment-specific vocabulary from local Codex and Claude history plus configured repository vocabulary.",
