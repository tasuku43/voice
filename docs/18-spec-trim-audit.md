...
- Local context model rebuild/export/import/delete UI is implemented, and the model stores source kinds plus last rebuild time; add a status panel for inspecting this metadata without rebuilding.
