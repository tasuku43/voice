...
REQUIRED_EVIDENCE_LABELS = [
    ...
    "No review/approval UI appears in Quick Paste",
    ...
    "Rebuild Local Context Model works without review/approval UI and shows rebuild metadata",
    "Rebuild summary shows last rebuild metadata",
    "Rebuilt Local Context Model affects later Quick Paste normalization without review/approval UI",
