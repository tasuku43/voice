...
| Local Foundation Model only if LLM is used | product docs, contracts, privacy validator network guards, and absence of an LLM conversion adapter in the current hotkey path | Verified for current source; adapter is deferred |
